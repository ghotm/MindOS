...
export async function GET(req: Request) {
  ...
  return toNextResponse(await handleRuntimeSessionProjectionsGet(url.searchParams, {
    listRuntimes: async () => {
      ...
      throw new Error('Failed to build runtime descriptors for session projections.');
    },
