...
export const OBSIDIAN_CAPABILITY_MATRIX: ObsidianCapabilityRow[] = [
  ...
  },
  {
    ...
    host: 'Plugin settings host',
    route: '/api/obsidian-plugins/settings',
    tests: ['obsidian-compat/setting-components.test.ts'],
    notes: 'Official abstract base: shared disabled state and then-chaining are real, but there is no DOM mounting in the server tier.',
  },
  {
    api: 'ValueComponent',
    surface: 'settings',
    ...
    route: '/api/obsidian-plugins/settings',
    tests: ['obsidian-compat/setting-components.test.ts'],
    notes: 'Official abstract base for valued controls; registerOptionListener transforms setValue input and subclasses implement getValue/setValue over the settings item.',
  },
  {
    api: 'AbstractTextComponent',
    surface: 'settings',
    support: 'limited',
    host: 'Plugin settings host',
    route: '/api/obsidian-plugins/settings',
    tests: ['obsidian-compat/setting-components.test.ts'],
    notes: 'Official base for text-like controls; value, placeholder and disabled semantics are captured, onChanged has no headless trigger source.',
  },
  {
    api: 'SliderComponent',
    surface: 'settings',
    ...
    route: '/api/obsidian-plugins/settings',
    tests: ['obsidian-compat/setting-components.test.ts'],
    notes: 'Numeric value, limits, pretty formatting and custom display format are captured; drag interaction itself has no server-tier equivalent.',
  },
  {
    api: 'ColorComponent',
    surface: 'settings',
    ...
    route: '/api/obsidian-plugins/settings',
    tests: ['obsidian-compat/setting-components.test.ts'],
    notes: 'Hex values round-trip with exact RGB/HSL conversion; invalid hex falls back to black on read.',
  },
  {
    api: 'SearchComponent',
    surface: 'settings',
    ...
    route: '/api/obsidian-plugins/settings',
    tests: ['obsidian-compat/setting-components.test.ts'],
    notes: 'Text-like search values are captured with a placeholder clear button; the clear interaction itself has no server-tier trigger.',
  },
  {
    api: 'TextComponent',
    surface: 'settings',
  ...
  {
    api: 'sanitizeHTMLToDom',
    surface: 'document',
    support: 'limited',
    host: 'Degraded sanitizer shim',
    tests: ['obsidian-compat/sanitize-html-to-dom.test.ts'],
    notes: 'Server tier degrades to injection-free text extraction: script/style blocks and comments are dropped, tags stripped, common entities decoded; the returned fragment carries text only. The browser tier should replace this with a real DOMPurify pass.',
  },
  {
    api: 'getIcon',
    surface: 'core',
  ...
  {
    api: 'EditableFileView',
    surface: 'views',
    support: 'catalog-only',
    host: 'Plugin view registry',
    route: '/api/obsidian-plugins/views',
    tests: ['obsidian-compat/text-file-view.test.ts'],
    notes: 'Empty intermediate base class on the official FileView chain, available for inheritance.',
  },
  {
    api: 'TextFileView',
    surface: 'views',
    ...
    route: '/api/obsidian-plugins/views',
    tests: ['obsidian-compat/text-file-view.test.ts'],
    notes: 'Real class with in-memory data, getViewData/setViewData/clear abstract contract, debounced requestSave and save(clear); vault persistence stays with the host.',
  },
  {
    api: 'SettingGroup',
    surface: 'settings',
  ...
  },
  {
    ...
    surface: 'views',
    support: 'limited',
    host: 'App workspace shim',
    route: '/plugins/views',
    tests: ['obsidian-compat/workspace-dom.test.ts', 'obsidian-compat/workspace.test.ts'],
    notes: 'The app.workspace shim class itself is exported so plugins can use instanceof and type guards; layout behaviour stays in the host.',
  },
  {
    api: 'WorkspaceItem',
    surface: 'views',
    support: 'catalog-only',
    host: 'Workspace DOM class shim',
    route: '/plugins/views',
    tests: ['obsidian-compat/workspace-dom.test.ts'],
    notes: 'Abstract base with parent-link getRoot/getContainer walking; standalone shim items carry a nullable parent.',
  },
  {
    api: 'WorkspaceParent',
    surface: 'views',
    ...
    route: '/plugins/views',
    tests: ['obsidian-compat/workspace-dom.test.ts'],
    notes: 'Abstract intermediate base on the official chain, available for inheritance.',
  },
  {
    api: 'WorkspaceSplit',
    surface: 'views',
    ...
    route: '/plugins/views',
    tests: ['obsidian-compat/workspace-dom.test.ts'],
    notes: 'Constructible split node with an optional parent link; no real layout engine in the server tier.',
  },
  {
    ...
    route: '/plugins/views',
    tests: ['obsidian-compat/workspace-dom.test.ts'],
    notes: 'Abstract container base on the official chain, available for inheritance.',
  },
  {
    api: 'WorkspaceWindow',
    surface: 'views',
    ...
    route: '/plugins/views',
    tests: ['obsidian-compat/workspace-dom.test.ts'],
    notes: 'Pop-window node with honest null win/doc handles; the server tier has no real window.',
  },
  {
    api: 'HoverPopover',
    surface: 'views',
    support: 'limited',
    host: 'Hover popover shim',
    route: '/plugins/views',
    tests: ['obsidian-compat/hover-popover.test.ts'],
    notes: 'Constructible popover that associates itself with the HoverParent and carries a fake hoverEl; no positioning or show/hide lifecycle in the server tier. PopoverState follows the official empty enum.',
  },
  {
    api: 'PopoverState',
    surface: 'views',
    ...
    route: '/plugins/views',
    tests: ['obsidian-compat/hover-popover.test.ts'],
    notes: 'The official 1.13.2 declaration ships this enum empty; the shim exports the same empty surface rather than inventing lifecycle values.',
  },
  {
    api: 'registerView',
    surface: 'views',
  ...
  {
    api: 'MarkdownPreviewRenderer',
    surface: 'document',
    support: 'limited',
    host: 'Markdown renderer shim',
    route: '/api/obsidian-plugins/markdown-code-blocks',
    tests: ['obsidian-compat/markdown-preview-renderer.test.ts'],
    notes: 'Static register/unregister keeps the post-processor contract with stable sort-order metadata; the snapshot render pipeline does not invoke the registry yet. Code block wrappers match by seeded language class.',
  },
  {
    api: 'sortSearchResults',
    surface: 'core',
    support: 'full',
    host: 'Search helpers shim',
    tests: ['obsidian-compat/sort-search-results.test.ts'],
    notes: 'In-place descending sort by match score with stable ties; entries without a usable match sink to the end instead of comparing NaN.',
  },
  {
