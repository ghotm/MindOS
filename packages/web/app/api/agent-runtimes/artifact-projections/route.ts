...
export async function GET(req: Request) {
  ...
  return toNextResponse(await handleAgentRuntimeArtifactProjectionsGet(url.searchParams, {
    listRuntimes: async () => {
      ...
      throw new Error('Failed to build runtime descriptors for artifact projections.');
    },
  }));
}
