/**
 * Secret redaction for agent run summaries, metadata, and event payloads.
 * Sunk from packages/web/lib/agent/redaction.ts (spec-agent-core-consolidation
 * Wave 2) — the run ledger persists through this module, so it lives beside it.
 */
