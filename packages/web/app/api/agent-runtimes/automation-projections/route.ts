...
export async function GET(req: Request) {
  ...
  return toNextResponse(await handleAgentRuntimeAutomationProjectionsGet(url.searchParams, {
    listRuntimes: async () => {
      ...
      throw new Error('Failed to build runtime descriptors for automation projections.');
    },
  }));
}
