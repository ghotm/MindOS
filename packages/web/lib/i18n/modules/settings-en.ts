...
export const settingsEn = {
  settings: {
    ...
    agent: {
      ...
      thinkingHint: 'Default Pi reasoning effort. Unsupported levels are adjusted for the selected model.',
      thinkingOff: 'Off',
    ...
    unsavedNotice: 'Settings were not saved',
    unsavedNoticeHint: 'Your changes are kept in this tab. Retry before refreshing or closing it.',
    retryingSaveNotice: 'Retrying settings save…',
    reviewUnsaved: 'Review settings',
    ...
    uninstall: {
      ...
      success: 'The uninstall request has been submitted. Background cleanup may take a moment; please verify the result afterwards.',
      successDesktop: 'The uninstall request has been submitted. The app will quit now; please verify the removal afterwards.',
      ...
      kbSafe: 'Your knowledge base is not removed separately. Removing configuration also deletes files in ~/.mindos/; back up anything important stored there first.',
    },
  },
} as const;
